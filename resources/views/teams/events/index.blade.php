            ...
            <div class="bid__block _block">
                ...
                <div class="bid__group">
                    ...
                    @livewire('event-list', [
                        ...
                        'selectedCity' => session('current_city'),
                        'selectedDistrict' => session('current_district'),
                        'selectedLocation' => session('current_location'),
                        'selectedLeague' => session('current_league'),
                    ], key($tournament->id))
