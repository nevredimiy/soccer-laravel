                    ...
                    <div class="players-section__items">
                        @foreach ($topPlayersByVote as $topPlayer)
                            <article style="--color: {{$topPlayer['team_color']}}" class="players-section__item item-player">
                                ...
                                <div data-rating-size="10" data-rating-value="{{$topPlayer['player']->rating}}" class="item-player__rating rating">
                                    <div class="rating__items">
                                        @for ($star=0; $star<10; $star++)
                                            @php
                                                $ratingClass = $star < $topPlayer['player']->rating ? 'rating__item--active' : '';
                                            @endphp
